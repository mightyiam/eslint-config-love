...
import { equivalents, ourDevDeps, ourRules } from './_util.js'
...
import {
  ...
  eslintVersion,
} from './_eslint-rules-metadata.js'
...
const deprecatedPluginRuleNames = rulesets.flatMap(([rules, pkgName]) =>
...
test('core rules metadata is up to date', (t) => {
  t.is(eslintVersion, ourDevDeps.eslint)
})
