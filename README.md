...
[![.github/workflows/ci.yaml](https://github.com/mightyiam/eslint-config-love/actions/workflows/ci.yaml/badge.svg?branch=master)](https://github.com/mightyiam/eslint-config-love/actions/workflows/ci.yaml)
